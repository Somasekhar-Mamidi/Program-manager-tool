...
import { MoreVertical, Paperclip, Link as LinkIcon, FileText, Image as ImageIcon, ChevronUp, ChevronDown, PenTool, ListTodo, GripVertical } from "lucide-react"
                        ...
                        <div className={cn(
                            ...
                            {pastMeetings.map(meeting => (
                                viewMode === 'grid' ? (
                                    ...
                                    <MeetingPrepCard key={meeting.id} meeting={meeting} isReadOnly={true} />
                                )
                            ))}
                        </div>
                    )}
                ...
                <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto">
                    ...
                    {selectedMeetingId && (
                        (() => {
                            ...
                            return <MeetingPrepCard meeting={meeting} isReadOnly={meeting.status === 'completed'} />
                        })()
                    )}
                </DialogContent>
            </Dialog>
...
function MeetingPrepCard({ meeting, isReadOnly = false }: { meeting: IntentBlock, isReadOnly?: boolean }) {
